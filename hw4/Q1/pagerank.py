...
"""
def author():                                                                                             
        return '903542539' # replace sroutray3 with your Georgia Tech username.                                                                                             
                                                                                              
def gtid():                                                                                               
    return 903542539 # replace with your GT ID number      
...
#############################################
                ...
                for i in range(len(scores)):
                        scores[i] = (1-damping_factor)*node_weights[i] + damping_factor*new_scores[i]
                pass
